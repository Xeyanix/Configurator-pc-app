...
function Contact() {
    return (
        <div id="contactSection" className={styles.contactSection}>
            <main
                className="wp-block-group has-background has-global-padding is-layout-constrained wp-container-core-group-layout-13 wp-block-group-is-layout-constrained"
                style={{ backgroundColor: '#f2e7df', marginTop: 0 }}
            >
                <div
                ...
                >
                    ...
                    >
                        <div
                            className="wp-block-cover__inner-container is-layout-flow wp-container-core-cover-layout-2 wp-block-cover-is-layout-flow"
                        >
                            <h2
                            ...
                            <ul class="wp-block-social-links has-visible-labels has-icon-color is-style-logos-only is-horizontal is-layout-flex wp-container-core-social-links-layout-1 wp-block-social-links-is-layout-flex">
                                <li
                                    ...
                                    <a
                                        ...
                                        <span class="wp-block-social-link-label">Bboy_Johnny</span>
                                    </a>
                                </li>
                            </ul>
                        </div >
